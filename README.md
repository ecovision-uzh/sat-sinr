...
This repository contains the code for replicating the experiments from [**Sat-SINR: High-Resolution Species Distribution Models through Satellite Imagery**](https://isprs-annals.copernicus.org/articles/X-2-2024/41/2024/).
