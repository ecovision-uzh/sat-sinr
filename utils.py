...
class DefaultParams():
    def __init__(self, sinr):
        ...
        self.local.sent_data_path = "/data/jdolli/glc23_data/SatelliteImages/"
        self.local.bioclim_lr_path = "/data/jdolli/glc23_data/sinr_data/data/env/bioclim_elevation_scaled_europe.npy"
        self.local.bioclim_path = "/data/jdolli/bioclim+elev/bioclim_elevation_scaled_europe.npy"
        self.local.dataset_file_path = "/data/jdolli/Pot_10_to_1000.csv"
        self.local.cp_dir_path = "/scratch/jdolli/sent-sinr/checkpoints"
        self.local.logs_dir_path = "/scratch/jdolli/sent-sinr/wandb_logs"
        self.local.val_data_path = "/data/jdolli/glc23_data/Presence_Absence_surveys/loc_to_spec.csv"
